 ...
 * 後視点座標の設定
 */
public class SokkiaCommand_Dd_in extends SokkiaCommand {

    private final String SEND_COMMAND = "/Dd";

    private final double x;
    private final double y;
    private final double z;

    public SokkiaCommand_Dd_in(double x, double y, double z) {
...
//				e.printStackTrace();
//			}
//		Command comm = new SokkiaCommand_Dd_in(20,0,0);
//		try {
//			comm.sendCommand();
