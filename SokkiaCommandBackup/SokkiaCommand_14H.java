...
public class SokkiaCommand_14H extends SokkiaCommand {

    private final static Logger logger = LogManager.getLogger(SokkiaCommand_14H.class);

    private final String SEND_COMMAND = "20";	// 0x11 = 17

    public SokkiaCommand_14H() {
...
//		System.out.println(((Command_11H) comm).getDistanceS());
    ...
    public double getDistanceS() {
        ...
        try {
            ...
            return Double.parseDouble(ret) / 10000.0;
